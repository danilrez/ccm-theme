...
export const gitDecoration = {
	...
	'gitDecoration.modifiedResourceForeground': getColor('violet', 300),
	...
	'gitDecoration.renamedResourceForeground': getColor('green', 300),
	// Color for staged modifications git decorations. Used for file labels and the SCM viewlet
	'gitDecoration.stageModifiedResourceForeground': getColor('violet', 400),
	...
	'gitDecoration.untrackedResourceForeground': getColor('green', 400),
