...
export const statusBar = {
	...
	'statusBarItem.errorHoverBackground': getColor('neutral', 50, 30),
	...
	'statusBarItem.warningHoverBackground': getColor('neutral', 50, 30),
	...
	'statusBarItem.compactHoverBackground': getColor('neutral', 50, 30),
