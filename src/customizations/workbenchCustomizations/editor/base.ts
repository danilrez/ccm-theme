...
export const editorBase = {
	...
	'editor.background': getHEXColor('neutral', 700),
	// Editor default foreground color
	'editor.foreground': getHEXColor('neutral', 300),
	// The background color of the editor line numbers
	'editorGutter.background': getHEXColor('neutral', 700),
	// Color of editor line numbers
	'editorLineNumber.foreground': getHEXColor('neutral', 500),
	// Color of the active editor line number
	'editorLineNumber.activeForeground': getHEXColor('neutral', 100),
	// Color of the final editor line when editor.renderFinalNewline is set to dimmed
	'editorLineNumber.dimmedForeground': DEFAULT,
	// The background color of the editor cursor. Allows customizing the color of a character overlapped by a block cursor
	'editorCursor.background': DEFAULT,
	// Color of the editor cursor
	'editorCursor.foreground': getHEXColor('yellow', 400),
	// Color of the primary editor cursor when multiple cursors are present
	'editorMultiCursor.primary.foreground': getHEXColor('yellow', 400),
	...
	'editorMultiCursor.secondary.foreground': getHEXColor('yellow', 300),
	...
	'editor.hoverHighlightBackground': getHEXColor('neutral', 200, 20),

	// NOTE: The current line is typically shown as either background highlight or a border (not both)
	// Background color for the highlight of line at the cursor position
	'editor.lineHighlightBackground': getHEXColor('neutral', 200, 10),
	...
	'editorLink.activeForeground': getHEXColor('blue', 400),

	// Background color used to highlight collapsed line of code
	'editor.foldBackground': getHEXColor('neutral', 500, 40),

	// Wavy underline for errors in the code
	'editorError.foreground': getHEXColor('red', 400),
	// Wavy underline for info messages or non-English text (e.g., Russian)
	'editorInfo.foreground': getHEXColor('blue', 400),
	// Wavy underline for warnings in the code
	'editorWarning.foreground': getHEXColor('yellow', 400),
	// Color of active indentation guides (overridden by bracket colors)
	'editorIndentGuide.activeBackground1': getHEXColor('neutral', 400),
	// Color of indentation guides
	'editorIndentGuide.background1': getHEXColor('neutral', 500),
	// Color of spaces and tabs
	'editorWhitespace.foreground': getHEXColor('neutral', 500),
	// Color of the text with author of changes
	'editorCodeLens.foreground': getHEXColor('neutral', 500),
};
